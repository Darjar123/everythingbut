...
class PosFormTest extends WebDriverTestBase {
  ...
  public function testWidgetSettings() {
    ...
    $settings['settings']['allow_decimal'] = TRUE;
   ...
   * Tests adding and removing products from the POS form.
   */
  public function testCommercePosFormDefaultPayment() {
    // Set a nonstandard default.
    \Drupal::configFactory()->getEditable('commerce_pos.settings')
      ->set('default_payment_gateway', 'pos_credit')
      ->save();
    ...
    $this->assertTrue($this->getSession()->getPage()->find('css', '#edit-pos-credit-keypad-amount')->isVisible());
    $this->assertFalse($this->getSession()->getPage()->find('css', '#edit-pos-cash-keypad-amount')->isVisible());
  }
