...
*/
class AddMusicForm extends FormBase
{
    ...
    public function buildForm(array $form, FormStateInterface $form_state)
    {
        ...
        $form['imdb_title'] = ['#type' => 'textfield', '#title' => t('IMDB Title') ,'#description' => '<div id="getinfomusic"><strong>Click here to get band info</strong></div>' , ];
     // Textarea.
        ...
        $form['actors'] = ['#type' => 'textarea', '#title' => t('Group') , ];
    ...
    public function submitForm(array & $form, FormStateInterface $form_state)
    {
        ...
        {
            $variation = \Drupal\commerce_product\Entity\ProductVariation::create(['type' => 'music', 'sku' => $values['sku']."_".$values['condition'] , 'price' => new Price($values['price'], 'CAD') , 'title' => $values['name'], 'field_upc' => $values['upc'], 'attribute_conditions' => $values['condition'] ]);
            ...
            $product = \Drupal\commerce_product\Entity\Product::create(['uid' => 1, 'type' => 'music', 'title' => $values['name'], 'stores' => $store, 'body' => $values['description'], 'variations' => $variation,  ]);
